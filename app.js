const getWeather = () => {
  ...
  const success = (position) => {
    ...
    // const sixthDay = document.getElementById("date6");
    // const temperature6 = document.getElementById("temp6");
    // const weatherIcon6 = document.getElementById("wicon6");
    // const decription6 = document.getElementById("decription6");
    ...
    fetch(url)
      ...
      .then((data) => {
        ...
        const weatherList = [day1, day2, day3, day4, day5, day6];

        date = day1.dt_txt.toString();
        ...
        // date6 = day6.dt_txt;
        // temp6 = Math.floor(day6.main.temp - 273);
        // min6 = Math.floor(day6.main.temp_min - 273);
        // max6 = Math.floor(day6.main.temp_max - 273);
        // des6 = day6.weather[0].description;
        // icon6 = day6.weather[0].icon;
        // iconUrl6 = "http://openweathermap.org/img/w/" + icon6 + ".png";
        ...
        // temperature6.innerHTML = temp6;
        // weatherIcon6.innerHTML = icon6;
        // decription6.innerHTML = des6;
      });
